  ...
  return (
    <View className='bg-primary flex-1'>
      <ScrollView contentContainerStyle={{
        ...
        <View className='flex-row items-center bg-dark-500 px-5 py-1 rounded-md gap-x-1 mt-2'>
        ...
        <MovieInfo label='Genres' value={movie?.genres?.map((g) => g.name).join(' - ') || 'N/A' } />
          <View className='flex flex-row justify-between w-1/2 '>
           ...
           <MovieInfo label='DEVELOPER OF THE MOVIE DETAILS APP' value='INNOPRO22 THE VPNZ MASTER' />
      </ScrollView>
